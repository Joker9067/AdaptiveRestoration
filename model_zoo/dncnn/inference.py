"""
Inference script for Dncnn model.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Dncnn restoration inference script")
    ...
    parser.add_argument("--checkpoint", type=str, default="./checkpoints/dncnn/best.pt", help="Checkpoint model weights path")
