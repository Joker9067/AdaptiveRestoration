"""
Inference script for Restormer model.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Restormer restoration inference script")
    ...
    parser.add_argument("--checkpoint", type=str, default="./checkpoints/restormer/best.pt", help="Checkpoint model weights path")
