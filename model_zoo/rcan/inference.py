"""
Inference script for RCAN model.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="RCAN restoration inference script")
    ...
    parser.add_argument("--checkpoint", type=str, default="./checkpoints/rcan/best.pt", help="Checkpoint model weights path")
