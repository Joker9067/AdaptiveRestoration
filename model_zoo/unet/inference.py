"""
Inference script for U-Net model.
...
def run_inference(input_path: str, output_path: str, checkpoint_path: str, gt_path: str = None) -> None:
    ...
    # Preprocess tensor: normalization and shape adjustments
    ...
    # 4. If ground truth is provided, evaluate metrics
...
if __name__ == "__main__":
    import os
    parser = argparse.ArgumentParser(description="U-Net restoration inference script")
    ...
    parser.add_argument("--checkpoint", type=str, default="./checkpoints/unet/best.pt", help="Checkpoint model weights path")
