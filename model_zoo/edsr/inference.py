"""
Inference script for EDSR model.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="EDSR restoration inference script")
    ...
    parser.add_argument("--checkpoint", type=str, default="./checkpoints/edsr/best.pt", help="Checkpoint model weights path")
