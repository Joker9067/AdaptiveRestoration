"""
Inference script for NAFNet model.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="NAFNet restoration inference script")
    ...
    parser.add_argument("--checkpoint", type=str, default="./checkpoints/nafnet/best.pt", help="Checkpoint model weights path")
