"""
Inference script for SwinIR model.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SwinIR restoration inference script")
    ...
    parser.add_argument("--checkpoint", type=str, default="./checkpoints/swinir/best.pt", help="Checkpoint model weights path")
